...
enum L {
  ...
  // Wallet identity hint (login screen)
  walletIdentityHint,
  ...
  // Match Detail / Battle Log
  battleLog,
  matchDetail,
  noRecordsBattleLog,
  noRecordsBattleLogDesc,
  connectionLost,
  connectionLostDesc,
  pieces,
  maxComboLabel,
...
class LocalizationService extends ChangeNotifier {
  ...
  static final Map<AppLanguage, Map<L, String>> _strings = {
    ...
    AppLanguage.english: {
      ...
      L.errorConnectWalletFirst: 'Please log in first',
      ...
      L.opponentKeepsPlaying: '⚠ OPPONENT KEEPS PLAYING',
      // Wallet Binding
      L.bindWallet: 'LOG IN',
      L.connectWallet: 'Connect Wallet',
      L.unlockGlobalRank: 'Unlock Global Rank',
      L.bindDescription: 'Log in to unlock global leaderboard and cloud sync features.',
      ...
      L.unbind: 'Unbind',
      L.unbindConfirm: 'Are you sure you want to log out? Your cloud scores will remain but you will need to log in again to access them.',
      L.cancel: 'Cancel',
      // Sync Score
      ...
      L.localTab: 'LOCAL',
      L.globalTab: 'GLOBAL',
      L.globalLocked: 'Log in to view global rankings',
      L.bindNow: 'BIND NOW',
      ...
      L.loginToChallenge: 'Log in to access Challenge mode',
      L.loginToUnlock: 'Log in to unlock cloud features',
      L.walletIdentityHint: 'Wallet connection is optional and used only as a player identity.',
      ...
      L.selectMode: 'SELECT MODE',
      L.scoreRace: 'SCORE RACE',
      L.scoreRaceDesc: '2 min - Highest score wins',
      L.survival: 'SURVIVAL',
      L.survivalDesc: 'Last standing wins',
      L.findOpponent: 'FIND OPPONENT',
      L.searching: 'SEARCHING...',
      L.findingOpponent: 'Finding opponent',
      L.matchNotFound: 'MATCH NOT FOUND',
      L.victory: 'VICTORY',
      L.defeat: 'DEFEAT',
      L.draw: 'DRAW',
      L.submitResult: 'SUBMIT RESULT',
      L.submittingResult: 'SUBMITTING...',
      L.submitFailed: 'SUBMIT FAILED',
      L.submitted: 'SUBMITTED',
      L.returnToMenu: 'RETURN TO MENU',
      L.alive: 'ALIVE',
      L.dead: 'DEAD',
      // Match History
      L.matchHistory: 'MATCH HISTORY',
      L.history: 'HISTORY',
      L.noMatchHistory: 'No matches yet',
      L.playToHistory: 'Play a challenge to start tracking',
      L.played: 'PLAYED',
      L.winRate: 'WIN RATE',
      L.streak: 'STREAK',
      L.won: 'WON',
      ...
      L.medium: 'Medium',
      L.hard: 'Hard',
      L.historyLoadFailed: 'Failed to load history',
      L.retry: 'RETRY',
      L.vs: 'vs',
      L.bestScore: 'BEST',
      // Match Detail / Battle Log
      L.battleLog: 'BATTLE LOG',
      L.matchDetail: 'MATCH DETAIL',
      L.noRecordsBattleLog: 'NO RECORDS',
      L.noRecordsBattleLogDesc: 'Complete a challenge to start building your battle log.',
      L.connectionLost: 'CONNECTION LOST',
      L.connectionLostDesc: 'Failed to load battle log.',
      L.pieces: 'PIECES',
      L.maxComboLabel: 'MAX COMBO',
      L.mode: 'MODE',
      L.duration: 'DURATION',
      L.date: 'DATE',
      L.seedLabel: 'SEED',
      ...
      L.style: 'STYLE',
      L.rewardLabel: 'REWARD',
      L.newRecord: 'NEW RECORD',
      L.ratingLabel: 'RATING',
      L.metadata: 'METADATA',
      L.matchId: 'MATCH ID',
      L.platform: 'PLATFORM',
      L.source: 'SOURCE',
      ...
      L.replayTitle: 'REPLAY',
      L.replayComplete: 'REPLAY COMPLETE',
      L.replayAgain: 'REPLAY AGAIN',
      L.saveVideo: 'SAVE VIDEO',
      L.savingVideo: 'Saving video...',
      L.savedToPhotos: 'Saved to Photos',
      L.saveVideoError: 'Failed to save video',
      L.speed: 'SPEED',
    ...
    AppLanguage.simplifiedChinese: {
      ...
      L.errorConnectWalletFirst: '请先登录',
      ...
      L.opponentKeepsPlaying: '⚠ 对手仍在继续比赛',
      // Wallet Binding
      L.bindWallet: '登录',
      L.connectWallet: '连接钱包',
      L.unlockGlobalRank: '解锁全球排名',
      L.bindDescription: '登录以解锁全球排行榜和云端同步功能。',
      ...
      L.unbind: '解绑',
      L.unbindConfirm: '确定要退出登录吗？你的云端分数会保留，但需要重新登录才能访问。',
      L.cancel: '取消',
      // Sync Score
      L.syncScores: '同步分数',
      ...
      L.loginToChallenge: '登录后才能参加挑战赛',
      L.loginToUnlock: '登录以解锁云端功能',
      L.walletIdentityHint: '钱包连接为可选项，仅用作玩家身份标识。',
      ...
      L.selectMode: '选择模式',
      L.scoreRace: '积分竞速',
      L.scoreRaceDesc: '2分钟 - 最高分获胜',
      L.survival: '生存模式',
      L.survivalDesc: '最后存活者获胜',
      L.findOpponent: '寻找对手',
      L.searching: '搜索中...',
      L.findingOpponent: '正在匹配对手',
      L.matchNotFound: '未找到对手',
      L.victory: '胜利',
      L.defeat: '失败',
      L.draw: '平局',
      L.submitResult: '提交成绩',
      L.submittingResult: '提交中...',
      L.submitFailed: '提交失败',
      L.submitted: '已提交',
      L.returnToMenu: '返回菜单',
      L.alive: '存活',
      ...
      L.matchHistory: '比赛记录',
      L.history: '记录',
      L.noMatchHistory: '暂无比赛记录',
      L.playToHistory: '完成挑战赛开始记录',
      L.played: '场次',
      L.winRate: '胜率',
      L.streak: '连胜',
      L.won: '胜',
      ...
      L.medium: '中等',
      L.hard: '困难',
      L.historyLoadFailed: '加载记录失败',
      L.retry: '重试',
      L.vs: 'vs',
      L.bestScore: '最高',
      L.battleLog: '战斗日志',
      L.matchDetail: '对战详情',
      L.noRecordsBattleLog: '暂无记录',
      L.noRecordsBattleLogDesc: '完成一场挑战，开始记录你的战斗日志。',
      L.connectionLost: '连接中断',
      L.connectionLostDesc: '无法加载战斗日志。',
      L.pieces: '方块数',
      L.maxComboLabel: '最大连击',
      L.mode: '模式',
      L.duration: '时长',
      L.date: '日期',
      L.seedLabel: '种子',
      ...
      L.comingSoon: '即将推出',
      L.replayTitle: '回放',
      L.replayComplete: '回放结束',
      L.replayAgain: '重新播放',
      L.saveVideo: '保存视频',
      L.savingVideo: '正在保存视频...',
      L.savedToPhotos: '已保存到相册',
      L.saveVideoError: '保存视频失败',
      L.speed: '速度',
      L.timeLimit: '时间限制',
      L.playerId: '玩家ID',
      L.you: '你',
    ...
    AppLanguage.traditionalChinese: {
      ...
      L.errorConnectWalletFirst: '請先登入',
      ...
      L.opponentKeepsPlaying: '⚠ 對手仍在繼續比賽',
      // Wallet Binding
      L.bindWallet: '登入',
      L.connectWallet: '連接錢包',
      L.unlockGlobalRank: '解鎖全球排名',
      L.bindDescription: '登入以解鎖全球排行榜和雲端同步功能。',
      L.benefitGlobalRanking: '全球排名',
      ...
      L.unbind: '解綁',
      L.unbindConfirm: '確定要登出嗎？你的雲端分數會保留，但需要重新登入才能訪問。',
      L.cancel: '取消',
      // Sync Score
      L.syncScores: '同步分數',
      ...
      L.loginToChallenge: '登入後才能參加挑戰賽',
      L.loginToUnlock: '登入以解鎖雲端功能',
      L.walletIdentityHint: '錢包連接為可選項，僅用作玩家身份標識。',
      ...
      L.selectMode: '選擇模式',
      L.scoreRace: '積分競速',
      L.scoreRaceDesc: '2分鐘 - 最高分獲勝',
      L.survival: '生存模式',
      L.survivalDesc: '最後存活者獲勝',
      L.findOpponent: '尋找對手',
      L.searching: '搜尋中...',
      L.findingOpponent: '正在配對對手',
      L.matchNotFound: '未找到對手',
      L.victory: '勝利',
      L.defeat: '失敗',
      L.draw: '平手',
      L.submitResult: '提交成績',
      ...
      L.matchHistory: '比賽記錄',
      L.history: '記錄',
      L.noMatchHistory: '暫無比賽記錄',
      L.playToHistory: '完成挑戰賽開始記錄',
      L.played: '場次',
      L.winRate: '勝率',
      L.streak: '連勝',
      L.won: '勝',
      ...
      L.medium: '中等',
      L.hard: '困難',
      L.historyLoadFailed: '載入記錄失敗',
      L.retry: '重試',
      L.vs: 'vs',
      L.bestScore: '最高',
      L.battleLog: '戰鬥日誌',
      L.matchDetail: '對戰詳情',
      L.noRecordsBattleLog: '暫無記錄',
      L.noRecordsBattleLogDesc: '完成一場挑戰，開始記錄你的戰鬥日誌。',
      L.connectionLost: '連線中斷',
      L.connectionLostDesc: '無法載入戰鬥日誌。',
      L.pieces: '方塊數',
      L.maxComboLabel: '最大連擊',
      L.mode: '模式',
      L.duration: '時長',
      L.date: '日期',
      L.seedLabel: '種子',
      ...
      L.comingSoon: '即將推出',
      L.replayTitle: '回放',
      L.replayComplete: '回放結束',
      L.replayAgain: '重新播放',
      L.saveVideo: '儲存影片',
      L.savingVideo: '正在儲存影片...',
      L.savedToPhotos: '已儲存到相簿',
      L.saveVideoError: '儲存影片失敗',
      L.speed: '速度',
      L.timeLimit: '時間限制',
      L.playerId: '玩家ID',
      L.you: '你',
    ...
    AppLanguage.japanese: {
      ...
      L.errorConnectWalletFirst: '先にログインしてください',
      ...
      L.opponentKeepsPlaying: '⚠ 対戦相手はプレイ中',
      // Wallet Binding
      L.bindWallet: 'ログイン',
      L.connectWallet: 'ウォレットを接続',
      L.unlockGlobalRank: 'グローバルランクを解除',
      L.bindDescription: 'ログインして、グローバルランキングとクラウド同期機能を解除しましょう。',
      ...
      L.unbind: '解除',
      L.unbindConfirm: 'ログアウトしますか？クラウドスコアは保持されますが、再度ログインが必要になります。',
      L.cancel: 'キャンセル',
      // Sync Score
      L.syncScores: 'スコアを同期',
      ...
      L.localTab: 'ローカル',
      L.globalTab: 'グローバル',
      L.globalLocked: 'ログインしてグローバルランキングを見る',
      L.bindNow: '今すぐ接続',
      ...
      L.loginToChallenge: 'チャレンジモードに参加するにはログインしてください',
      L.loginToUnlock: 'ログインしてクラウド機能を有効にする',
      L.walletIdentityHint: 'ウォレット接続は任意で、プレイヤーIDとしてのみ使用されます。',
      ...
      L.selectMode: 'モード選択',
      L.scoreRace: 'スコアレース',
      L.scoreRaceDesc: '2分 - 最高スコアで勝利',
      L.survival: 'サバイバル',
      L.survivalDesc: '最後まで生き残れ',
      L.findOpponent: '対戦相手を探す',
      L.searching: '検索中...',
      L.findingOpponent: '対戦相手を探しています',
      L.matchNotFound: '対戦相手が見つかりません',
      L.victory: '勝利',
      L.defeat: '敗北',
      L.draw: '引き分け',
      L.submitResult: '結果を送信',
      L.submittingResult: '送信中...',
      L.submitFailed: '送信失敗',
      L.submitted: '送信済み',
      L.returnToMenu: 'メニューに戻る',
      L.alive: '生存',
      L.dead: '脱落',
      L.matchHistory: '対戦履歴',
      L.history: '履歴',
      L.noMatchHistory: 'まだ対戦なし',
      L.playToHistory: 'チャレンジをプレイして記録開始',
      L.played: '試合数',
      L.winRate: '勝率',
      L.streak: '連勝',
      L.won: '勝利',
      ...
      L.medium: '中',
      L.hard: '難',
      L.historyLoadFailed: '履歴読込失敗',
      L.retry: '再試行',
      L.vs: 'vs',
      L.bestScore: '最高',
      L.battleLog: 'バトルログ',
      L.matchDetail: '対戦詳細',
      L.noRecordsBattleLog: '記録なし',
      L.noRecordsBattleLogDesc: 'チャレンジを完了してバトルログを作成しましょう。',
      L.connectionLost: '接続エラー',
      L.connectionLostDesc: 'バトルログを読み込めませんでした。',
      L.pieces: 'ピース',
      L.maxComboLabel: '最大コンボ',
      L.mode: 'モード',
      L.duration: '時間',
      L.date: '日付',
      L.seedLabel: 'シード',
      ...
      L.comingSoon: '近日公開',
      L.replayTitle: 'リプレイ',
      L.replayComplete: 'リプレイ完了',
      L.replayAgain: 'もう一度再生',
      L.saveVideo: '動画を保存',
      L.savingVideo: '動画を保存中...',
      L.savedToPhotos: '写真に保存しました',
      L.saveVideoError: '動画の保存に失敗しました',
      L.speed: '速度',
      L.timeLimit: '制限時間',
      L.playerId: 'プレイヤーID',
      L.you: '自分',
    ...
    AppLanguage.korean: {
      ...
      L.errorConnectWalletFirst: '먼저 로그인하세요',
      ...
      L.opponentKeepsPlaying: '⚠ 상대방은 계속 플레이 중',
      // Wallet Binding
      L.bindWallet: '로그인',
      L.connectWallet: '지갑 연결',
      L.unlockGlobalRank: '글로벌 랭크 잠금 해제',
      L.bindDescription: '로그인하여 글로벌 랭킹과 클라우드 동기화 기능을 잠금 해제하세요.',
      ...
      L.unbind: '연결 해제',
      L.unbindConfirm: '로그아웃하시겠습니까? 클라우드 점수는 유지되지만 다시 로그인해야 접근할 수 있습니다.',
      L.cancel: '취소',
      // Sync Score
      L.syncScores: '점수 동기화',
      ...
      L.localTab: '로컬',
      L.globalTab: '글로벌',
      L.globalLocked: '로그인하여 글로벌 랭킹 보기',
      L.bindNow: '지금 연결',
      ...
      L.loginToChallenge: '챌린지 모드에 참여하려면 로그인하세요',
      L.loginToUnlock: '로그인하여 클라우드 기능 잠금 해제',
      L.walletIdentityHint: '지갑 연결은 선택 사항이며, 플레이어 신원 확인에만 사용됩니다.',
      ...
      L.selectMode: '모드 선택',
      L.scoreRace: '스코어 레이스',
      L.scoreRaceDesc: '2분 - 최고 점수 승리',
      L.survival: '서바이벌',
      L.survivalDesc: '최후의 생존자 승리',
      L.findOpponent: '상대 찾기',
      L.searching: '검색 중...',
      L.findingOpponent: '상대를 찾는 중',
      L.matchNotFound: '상대를 찾을 수 없습니다',
      L.victory: '승리',
      L.defeat: '패배',
      L.draw: '무승부',
      L.submitResult: '결과 제출',
      L.submittingResult: '제출 중...',
      L.submitFailed: '제출 실패',
      L.submitted: '제출 완료',
      L.returnToMenu: '메뉴로 돌아가기',
      L.alive: '생존',
      L.dead: '탈락',
      L.matchHistory: '대전 기록',
      L.history: '기록',
      L.noMatchHistory: '아직 대전 없음',
      L.playToHistory: '도전전을 플레이하세요',
      L.played: '대전 수',
      L.winRate: '승률',
      L.streak: '연승',
      L.won: '승리',
      ...
      L.medium: '보통',
      L.hard: '어려움',
      L.historyLoadFailed: '기록 로드 실패',
      L.retry: '재시도',
      L.vs: 'vs',
      L.bestScore: '최고',
      L.battleLog: '배틀 로그',
      L.matchDetail: '대전 상세',
      L.noRecordsBattleLog: '기록 없음',
      L.noRecordsBattleLogDesc: '챌린지를 완료하여 배틀 로그를 시작하세요.',
      L.connectionLost: '연결 끊김',
      L.connectionLostDesc: '배틀 로그를 불러올 수 없습니다.',
      L.pieces: '피스',
      L.maxComboLabel: '최대 콤보',
      L.mode: '모드',
      L.duration: '시간',
      L.date: '날짜',
      L.seedLabel: '시드',
      ...
      L.comingSoon: '출시 예정',
      L.replayTitle: '리플레이',
      L.replayComplete: '리플레이 완료',
      L.replayAgain: '다시 재생',
      L.saveVideo: '영상 저장',
      L.savingVideo: '영상 저장 중...',
      L.savedToPhotos: '사진에 저장됨',
      L.saveVideoError: '영상 저장 실패',
      L.speed: '속도',
      L.timeLimit: '제한 시간',
      L.playerId: '플레이어 ID',
      L.you: '나',
    ...
    AppLanguage.french: {
      ...
      L.errorConnectWalletFirst: 'Veuillez d\'abord vous connecter',
      ...
      L.opponentKeepsPlaying: '⚠ L\'ADVERSAIRE CONTINUE',
      // Wallet Binding
      L.bindWallet: 'CONNEXION',
      L.connectWallet: 'Connecter portefeuille',
      L.unlockGlobalRank: 'Débloquer le rang mondial',
      L.bindDescription: 'Connectez-vous pour débloquer le classement mondial et la synchronisation cloud.',
      ...
      L.unbind: 'Délier',
      L.unbindConfirm: 'Voulez-vous vraiment vous déconnecter ? Vos scores cloud seront conservés mais vous devrez vous reconnecter pour y accéder.',
      L.cancel: 'Annuler',
      // Sync Score
      ...
      L.localTab: 'LOCAL',
      L.globalTab: 'MONDIAL',
      L.globalLocked: 'Connectez-vous pour voir le classement mondial',
      ...
      L.loginToChallenge: 'Connectez-vous pour accéder au mode Défi',
      L.loginToUnlock: 'Connectez-vous pour débloquer les fonctionnalités cloud',
      L.walletIdentityHint: 'La connexion au portefeuille est optionnelle et sert uniquement d\'identité joueur.',
      ...
      // Challenge Mode
      L.challenge: 'DÉFI',
      L.selectMode: 'CHOISIR LE MODE',
      L.scoreRace: 'COURSE AU SCORE',
      L.scoreRaceDesc: '2 min - Le meilleur score gagne',
      L.survival: 'SURVIE',
      L.survivalDesc: 'Le dernier debout gagne',
      L.findOpponent: 'TROUVER UN ADVERSAIRE',
      L.searching: 'RECHERCHE...',
      L.findingOpponent: 'Recherche d\'adversaire',
      L.matchNotFound: 'ADVERSAIRE INTROUVABLE',
      L.victory: 'VICTOIRE',
      L.defeat: 'DÉFAITE',
      L.draw: 'ÉGALITÉ',
      L.submitResult: 'SOUMETTRE LE RÉSULTAT',
      L.submittingResult: 'ENVOI...',
      L.submitFailed: 'ENVOI ÉCHOUÉ',
      L.submitted: 'ENVOYÉ',
      L.returnToMenu: 'RETOUR AU MENU',
      L.alive: 'EN VIE',
      L.dead: 'ÉLIMINÉ',
      L.matchHistory: 'HISTORIQUE DES MATCHS',
      L.history: 'HISTORIQUE',
      L.noMatchHistory: 'Aucun match joué',
      L.playToHistory: 'Jouez un défi pour commencer',
      L.played: 'JOUÉS',
      L.winRate: 'VICTOIRES',
      L.streak: 'SÉRIE',
      L.won: 'GAGNÉ',
      ...
      L.medium: 'Moyen',
      L.hard: 'Difficile',
      L.historyLoadFailed: 'Échec du chargement',
      L.retry: 'RÉESSAYER',
      L.vs: 'vs',
      L.bestScore: 'RECORD',
      L.battleLog: 'JOURNAL DE COMBAT',
      L.matchDetail: 'DÉTAIL DU MATCH',
      L.noRecordsBattleLog: 'AUCUN RECORD',
      L.noRecordsBattleLogDesc: 'Terminez un défi pour commencer votre journal de combat.',
      L.connectionLost: 'CONNEXION PERDUE',
      L.connectionLostDesc: 'Impossible de charger le journal.',
      L.pieces: 'PIÈCES',
      L.maxComboLabel: 'COMBO MAX',
      L.mode: 'MODE',
      L.duration: 'DURÉE',
      L.date: 'DATE',
      L.seedLabel: 'GRAINE',
      ...
      L.style: 'STYLE',
      L.rewardLabel: 'RÉCOMPENSE',
      L.newRecord: 'NOUVEAU RECORD',
      L.ratingLabel: 'CLASSEMENT',
      L.metadata: 'MÉTADONNÉES',
      L.matchId: 'ID DU MATCH',
      L.platform: 'PLATEFORME',
      L.source: 'SOURCE',
      L.ruleset: 'RÈGLES',
      L.replay: 'REPLAY',
      L.comingSoon: 'Bientôt',
      L.replayTitle: 'REPLAY',
      L.replayComplete: 'REPLAY TERMINÉ',
      L.replayAgain: 'REJOUER',
      L.saveVideo: 'SAUVEGARDER',
      L.savingVideo: 'Sauvegarde en cours...',
      L.savedToPhotos: 'Sauvegardé dans Photos',
      L.saveVideoError: 'Échec de la sauvegarde',
      L.speed: 'VITESSE',
      L.timeLimit: 'LIMITE',
      L.playerId: 'ID JOUEUR',
      L.you: 'VOUS',
      L.opp: 'ADV',
    },
    ...
    AppLanguage.german: {
      ...
      L.errorConnectWalletFirst: 'Bitte melden Sie sich zuerst an',
      ...
      L.opponentKeepsPlaying: '⚠ GEGNER SPIELT WEITER',
      // Wallet Binding
      L.bindWallet: 'ANMELDEN',
      L.connectWallet: 'Wallet verbinden',
      L.unlockGlobalRank: 'Globalen Rang freischalten',
      L.bindDescription: 'Melden Sie sich an, um die globale Rangliste und Cloud-Synchronisierung freizuschalten.',
      ...
      L.unbind: 'Trennen',
      L.unbindConfirm: 'Möchten Sie sich wirklich abmelden? Ihre Cloud-Punkte bleiben erhalten, aber Sie müssen sich erneut anmelden, um darauf zuzugreifen.',
      L.cancel: 'Abbrechen',
      // Sync Score
      ...
      L.localTab: 'LOKAL',
      L.globalTab: 'GLOBAL',
      L.globalLocked: 'Melden Sie sich an, um die globale Rangliste zu sehen',
      ...
      L.loginToChallenge: 'Melden Sie sich an, um den Herausforderungsmodus zu nutzen',
      L.loginToUnlock: 'Anmelden, um Cloud-Funktionen freizuschalten',
      L.walletIdentityHint: 'Die Wallet-Verbindung ist optional und dient nur als Spieleridentität.',
      ...
      L.selectMode: 'MODUS WÄHLEN',
      L.scoreRace: 'PUNKTE-RENNEN',
      L.scoreRaceDesc: '2 Min - Höchster Score gewinnt',
      L.survival: 'ÜBERLEBEN',
      L.survivalDesc: 'Letzter Überlebender gewinnt',
      L.findOpponent: 'GEGNER FINDEN',
      L.searching: 'SUCHE...',
      L.findingOpponent: 'Gegner wird gesucht',
      L.matchNotFound: 'KEIN GEGNER GEFUNDEN',
      L.victory: 'SIEG',
      L.defeat: 'NIEDERLAGE',
      L.draw: 'UNENTSCHIEDEN',
      L.submitResult: 'ERGEBNIS SENDEN',
      L.submittingResult: 'WIRD GESENDET...',
      L.submitFailed: 'SENDEN FEHLGESCHLAGEN',
      L.submitted: 'GESENDET',
      L.returnToMenu: 'ZURÜCK ZUM MENÜ',
      L.alive: 'LEBT',
      L.dead: 'AUSGESCHIEDEN',
      L.matchHistory: 'SPIELVERLAUF',
      L.history: 'VERLAUF',
      L.noMatchHistory: 'Noch keine Spiele',
      L.playToHistory: 'Spielen Sie eine Herausforderung',
      L.played: 'GESPIELT',
      L.winRate: 'SIEGRATE',
      L.streak: 'SERIE',
      L.won: 'SIEG',
      ...
      L.medium: 'Mittel',
      L.hard: 'Schwer',
      L.historyLoadFailed: 'Laden fehlgeschlagen',
      L.retry: 'ERNEUT',
      L.vs: 'vs',
      L.bestScore: 'BEST',
      L.battleLog: 'KAMPFPROTOKOLL',
      L.matchDetail: 'MATCH-DETAILS',
      L.noRecordsBattleLog: 'KEINE EINTRÄGE',
      L.noRecordsBattleLogDesc: 'Schließe eine Herausforderung ab, um dein Kampfprotokoll zu starten.',
      L.connectionLost: 'VERBINDUNG VERLOREN',
      L.connectionLostDesc: 'Kampfprotokoll konnte nicht geladen werden.',
      L.pieces: 'TEILE',
      L.maxComboLabel: 'MAX COMBO',
      L.mode: 'MODUS',
      L.duration: 'DAUER',
      ...
      L.style: 'STIL',
      L.rewardLabel: 'BELOHNUNG',
      L.newRecord: 'NEUER REKORD',
      L.ratingLabel: 'BEWERTUNG',
      ...
      L.ruleset: 'REGELWERK',
      L.replay: 'REPLAY',
      L.comingSoon: 'Bald verfügbar',
      L.replayTitle: 'REPLAY',
      L.replayComplete: 'REPLAY BEENDET',
      L.replayAgain: 'NOCHMALS',
      L.saveVideo: 'VIDEO SPEICHERN',
      L.savingVideo: 'Video wird gespeichert...',
      L.savedToPhotos: 'In Fotos gespeichert',
      L.saveVideoError: 'Speichern fehlgeschlagen',
      L.speed: 'TEMPO',
      L.timeLimit: 'ZEITLIMIT',
      L.playerId: 'SPIELER-ID',
      L.you: 'DU',
      L.opp: 'GGN',
    },
  };
